              ...
              >
                <div className="p-4">
                  <div className="flex gap-3 items-center mb-4">
                    <div className="overflow-hidden w-12 h-12 rounded-full border-2 border-primary-500">
                      {userImage ? (
                        <img
                          src={userImage}
                          alt={userName}
        ...
        <div className="relative z-10 px-4 mx-auto w-full max-w-7xl sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex gap-4 items-center">
              ...
              {isLoading ? (
                <div className="w-6 h-6 rounded-full border-2 animate-spin border-primary-500 border-t-transparent" />
              ) : loginError ? (
                <div className="text-sm text-red-500">Auth Error - Try Again</div>
              ) : !isAuthenticated ? (
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={handleLogin}
                  className="flex overflow-hidden relative justify-center items-center px-8 py-3 font-normal text-white bg-gradient-to-r rounded-xl transition-all duration-300 from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 shadow-ambient hover:shadow-ambient-lg"
                >
                  <motion.div
